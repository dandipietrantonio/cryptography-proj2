...
CREATE TABLE `messages` (
  ...
  CONSTRAINT `fk_messages_author` FOREIGN KEY (`author`) REFERENCES `users` (`username`),
  CONSTRAINT `fk_messages_recipient` FOREIGN KEY (`recipient`) REFERENCES `users` (`username`)
...
--
-- Dumping routines for database 'crypto_proj'
--
...
-- Dump completed on 2022-05-03 13:44:08
